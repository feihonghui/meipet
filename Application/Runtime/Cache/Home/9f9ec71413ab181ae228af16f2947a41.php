        ...
        <div class="logo-container">
            <div class="layout-990">
                <div class="login-form">
                    <div class="message ms-yh">找回密码</div>
                    <form action="http://www.meipet.com.cn/index.php/Home/Log/doLog" method="post">
                        ...
                        <input type="text" name="mobile" id="mobile" value="" placeholder="新密码"/>
                        <input type="password" name="password" id="password" value="" placeholder="新密码确认"/>
                        <span class="do">确&nbsp;认</span>
                    </form>
                </div>
            </div>
        </div>
