...
<article id="indexContent">
    <div class="option ms-yh">
        <ul class="fd-clr tab-title">
        ...
        <div class="tab-content">
            <div class="content-box current">
                <div class="content-container">
                    <div class="content-top ms-yh">
                        <div class="title-box">
                            <span class="big-title"><a href="#">有偿领养</a></span>
                            <span class="small-title">最新发布</span>
                        </div>
                        <ul class="select-box">
                            <li class="select">最新猫咪</li>
                            <li>最新狗狗</li>
                        </ul>
                    </div>
            ...
            <div class="content-box">
                <div class="content-container">
                    <div class="content-top ms-yh">
                        <div class="title-box">
                            <span class="big-title"><a href="#">无偿领养</a></span>
                            <span class="small-title">最新发布</span>
                        </div>
                        <ul class="select-box">
                            <li class="select">最新猫咪</li>
...
<footer id="beautyFooter">
    <div class="copyright ms-yh">
