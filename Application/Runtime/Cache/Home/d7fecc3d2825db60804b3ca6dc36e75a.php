...
<<<<<<< HEAD
                    <div class="message ms-yh">登录美优萌宠</div>
                    <form action="http://www.meipet.com.cn/index.php/Home/Log/doLog" method="post">
                        ...
                        <span class="do">登&nbsp;录</span>
=======
                    <div class="message ms-yh" id="message">登录美优萌宠</div>
                    <form method="post">
                        <input type="text" id="mobile" placeholder="手机号"/>
                        <input type="password" id="password" placeholder="密码"/>
                        <a href="/forget">忘记密码？</a><br/>
                        <span class="do" id="do-log">登&nbsp;录</span>
>>>>>>> 27c8da4422b699cdac9a4898ad5a4709801476c1
                    </form>
                    <ul>
                        <li>还没有账号？<a href="/reg"> 立即注册</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<script type="text/javascript" src="/static/js/page/log/v1.js"></script>
</html>