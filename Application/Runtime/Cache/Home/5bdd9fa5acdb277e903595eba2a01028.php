...
<head>
    ...
    <!-- page-->
    <link rel="stylesheet" type="text/css" href="http://www.meipet.com.cn/static/css/page/center/v1.css">
</head>
...
<body>
    ...
    <div id="content">
        <div class="layout-990">
            <div class="mod-user">
                <div class="box">
                    <img onerror="this.src='http://i04.c.aliimg.com/cms/upload/2014/821/102/2201128_1754507855.png'" src="<?php echo ($user["face_img"]); ?>"/>
                </div>
                <h3><?php echo ($store["name"]); ?></h3>
                <p><?php echo ($store["dec"]); ?></p>
            </div>
            <div class="mod-content fd-clr">
                    <ul class="tab-title">
                        <li class="current">
                            <a href="#">待领养</a>
                        </li>
            ...
            <div class="mod-shop">
                <h3>店铺基本情况</h3>
                <div class="box">
                    <img src="<?php echo ($store["img"]); ?>">
                </div>
                <ul>
                    <li class="fd-clr first">
                        <span class="title">店铺资质:</span>
                        <span class="description"><?php echo ($user["type"]); ?></span>
                    </li>
                    <li class="fd-clr">
                        <span class="title">联系电话:</span>
                        <span class="description"><?php echo ($store["phone"]); ?></span>
                    </li>
                    <li class="fd-clr">
                        <span class="title">主营业务:</span>
                        <span class="description">
	                        <?php if(($store["adopt"] == 'Y')): ?><em>领养</em><?php endif; ?>
							<?php if(($store["cosmet"] == 'Y')): ?><em>美容</em><?php endif; ?>
							<?php if(($store["wash"] == 'Y')): ?><em>洗护</em><?php endif; ?>
							<?php if(($store["medical"] == 'Y')): ?><em>医疗</em><?php endif; ?>
                        </span>
                    </li>
                    <li class="fd-clr">
                        <span class="title">所在区域:</span>
                        <span class="description"><?php echo ($user["city"]); ?> <?php echo ($user["area"]); ?></span>
                    </li>
                </ul>
            </div>
        </div>
