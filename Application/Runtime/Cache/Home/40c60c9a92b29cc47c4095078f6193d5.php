...
<head>
    ...
    <!-- page-->
    <link rel="stylesheet" type="text/css" href="/static/css/page/center/v1.css">
</head>
    ...
    <div id="content">
        <div class="layout-990">
            <div class="mod-user">
                ...
                <h3>阿猫阿狗宠物店</h3>
                <p>店铺宣言：阿猫阿狗宠物店阿猫阿狗宠物店阿猫阿狗宠物店阿猫阿狗宠物店。</p>
            </div>
            ...
            <div class="mod-shop">
                <h3>店铺基本情况</h3>
                <div class="box">
                    <img src="http://i.epetbar.com/nowater/2015-05/26/231b0c0213f2f271df839fcc2073dc4c.jpg-400-200-c.jpg">
                </div>
                <ul>
                    <li class="fd-clr first">
                        <span class="title">店铺资质:</span>
                        <span class="description">个体经营</span>
                    </li>
                    <li class="fd-clr">
                        <span class="title">联系电话:</span>
                        <span class="description">18757103785</span>
                    </li>
                    <li class="fd-clr">
                        <span class="title">主营业务:</span>
                        <span class="description">领养、美容、洗护、医疗</span>
                    </li>
                    <li class="fd-clr">
                        <span class="title">所在区域:</span>
                        <span class="description">杭州市滨江区</span>
                    </li>
                </ul>
            </div>
        </div>
